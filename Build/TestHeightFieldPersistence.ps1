...
try {
    & 'C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe' Build/Tests/HeightFieldPersistence.vcxproj /m /p:Configuration=Debug /p:Platform=x64 /v:minimal /nologo
