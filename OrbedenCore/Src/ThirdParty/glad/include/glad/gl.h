/**
 * Loader generated by glad 2.0.8 on Thu Jun 11 10:59:08 2026
 *
...
typedef void (GLAD_API_PTR *PFNGLBINDFRAGDATALOCATIONPROC)(GLuint program, GLuint color3, const GLchar * name);
